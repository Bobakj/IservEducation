...
class App:
    def __init__(self):
        ...
        self.__screen_widght = self.__window.winfo_screenwidth()
    ...
    def start_form(self):
        ...
        registration_but.place(anchor="center", relx=0.5, rely=0.5)
    ...
    def start(self):
        self.__window.geometry(f"{self.__width_window}x{self.__height_window}+{self.__x}+{self.__y}")
